...
void myData()
{
	...
	float vertices[] = 
	{
		...
		//Letra I
		 -0.9f,  0.8f, 0.0f, 0.3f, 0.5f, 0.0f,  // 
		 -0.2f,  0.8f, 0.0f, 0.3f, 0.5f, 0.0f, // 
		 -0.2f,  0.6f, 0.0f, 0.3f, 0.5f, 0.0f, // 
		 -0.9f,  0.6f, 0.0f, 0.3f, 0.5f, 0.0f,  // 
		 ...
		 -0.6f, 0.6f, 0.0f, 0.3f, 0.5f, 0.0f,  // 
		 -0.45f, 0.6f, 0.0f, 0.3f, 0.5f, 0.0f, // 
		 -0.45f, -0.6f, 0.0f, 0.3f, 0.5f, 0.0f, // 
		 -0.6f, -0.6f, 0.0f, 0.3f, 0.5f, 0.0f,  // 
			//Letra H
		 0.05f,  0.8f, 0.0f, 0.3f, 0.5f, 0.0f,  // 
		 0.2f,  0.8f, 0.0f, 0.3f, 0.5f, 0.0f, // 
		 0.2f, -0.8f, 0.0f, 0.3f, 0.5f, 0.0f, // 
		 0.05f, -0.8f, 0.0f, 0.3f, 0.5f, 0.0f,  // 

		 0.65f,  0.8f, 0.0f, 0.3f, 0.5f, 0.0f,  // 
		 0.8f,  0.8f, 0.0f, 0.3f, 0.5f, 0.0f, // 
		 0.8f, -0.8f, 0.0f, 0.3f, 0.5f, 0.0f, // 
		 0.65f, -0.8f, 0.0f, 0.3f, 0.5f, 0.0f,  // 
	
		 0.2f,  0.1f, 0.0f, 0.3f, 0.5f, 0.0f, // 
		 0.65f,  0.1f, 0.0f, 0.3f, 0.5f, 0.0f, // 
		 0.65f, -0.1f, 0.0f, 0.3f, 0.5f, 0.0f,  // 
		 0.2f, -0.1f, 0.0f, 0.3f, 0.5f, 0.0f // 
